      ...
      <>
        <footer>
          <div className="sec1">
            ...
            <div className="main-footer">
              ...
              <div className="foot3">
                ...
                <div className="foot3-2">
                  ...
                  <nav>
                    <a href="#"><p>Restoran For Enterprise</p></a>
                  </nav>
                </div>
              </div>
              <div className="foot4">
            ...
            <hr className="h-line" />
            <p className="copyright">By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy, and Content Policies. All trademarks are properties of their respective owners. 2025 © Restoran Ltd. All rights reserved.</p>
          </div>
        </footer>
      </>
    );
