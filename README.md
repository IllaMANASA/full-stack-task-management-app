# RESTORAN - Food Delivery Platform 🚀

## Overview

RESTORAN is a dynamic food delivery website created with the Swiggy API. It provides users with a seamless and interactive experience for discovering and ordering food from various restaurants.

## Key Features

- **Location-wise Rendering:** Discover restaurants based on your location. RESTORAN intelligently adapts to your location or defaults to a specific city.
